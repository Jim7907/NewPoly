...
|---|---|---|
| Weekly NielsenIQ scanner data across the contiguous US (2006 to 2019) show a positive, statistically significant effect of wildfire smoke PM2.5 on retail sales of air purifiers, nasal products, cough remedies and bottled water, with dynamic effects: a one-week lag of smoke exposure still raises sales, at a smaller magnitude than the exposure week itself. | "A Burning Issue: Wildfire Smoke Exposure, Retail Sales, and Demand for Adaptation in Healthcare" (working paper, 2024); related: "Wildfires, smoke pollution, and household purchasing behaviors", *Journal of Economic Behavior and Organization* (2026) | The purchase response is real and national. The lag structure is the load-bearing part: the effect is largest in the week of exposure and still significant, though smaller, at a one-week lag. The paper fits lags up to four weeks but does not report weeks 2 to 4 as individually significant, so the defensible campaign window is the event week plus the following week. |
...
| Purchase response is still significant at a one-week lag, smaller than in the exposure week (NielsenIQ scanner studies) | Event campaigns run through the exposure week and the week after, tapering rather than stopping when the plume clears |
...
- A Burning Issue: Wildfire Smoke Exposure, Retail Sales, and Demand for Adaptation in Healthcare. *Environmental and Resource Economics* (2024). https://link.springer.com/article/10.1007/s10640-024-00925-3
